...
function NewDossier(props) {
  ...
  return (
    <ScrollView style={{ backgroundColor: white }} >
      ...
      <TouchableWithoutFeedback onPress={() => setDropControl2(!dropControl2)}>
        <View style={styles.dropMenu}>
          <Text style={styles.text}>Caratteristiche Immobili</Text>
          {dropControl2 ? <UpArrow width={20} height={20} /> : <DownArrow width={20} height={20} />}
        </View>
      </TouchableWithoutFeedback>
      ...
      <TouchableWithoutFeedback onPress={() => setDropControl3(!dropControl3)}>
        <View style={styles.dropMenu}>
          <Text style={styles.text}>Caratteristiche Fabbricato</Text>
          {dropControl3 ? <UpArrow width={20} height={20} /> : <DownArrow width={20} height={20} />}
        </View>
      </TouchableWithoutFeedback>
      {dropControl3 ? <View style={styles.marginStyle}>
      ...
      <TouchableWithoutFeedback onPress={() => setDropControl4(!dropControl4)}>
        <View style={styles.dropMenu}>
          <Text style={styles.text}>Situazione Finanziaria</Text>
          {dropControl4 ? <UpArrow width={20} height={20} /> : <DownArrow width={20} height={20} />}
        </View>
      </TouchableWithoutFeedback>
      {dropControl4 ? <View style={styles.marginStyle}>
      ...
      <TouchableWithoutFeedback onPress={() => setDropControl5(!dropControl5)}>
        <View style={styles.dropMenu}>
          <Text style={styles.text}>Situazione Locativa</Text>
          {dropControl5 ? <UpArrow width={20} height={20} /> : <DownArrow width={20} height={20} />}
        </View>
      </TouchableWithoutFeedback>
      {dropControl5 ? <View>
        <View style={styles.situazioneLocativaView}>
      ...
      <TouchableWithoutFeedback onPress={() => setDropControl6(!dropControl6)}>
        <View style={styles.dropMenu}>
          <Text style={styles.text}>Punteggio Importanza Fascicolo</Text>

          {dropControl6 ? <UpArrow width={20} height={20} /> : <DownArrow width={20} height={20} />}
        </View>
      </TouchableWithoutFeedback>
      {dropControl6 ? <View>
